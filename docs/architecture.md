...
authority, repair vetoes, validation-gated second-pass refinement, model bake-off gates, and legal
model-pack resolution. Model-specific inference remains isolated behind callbacks;
